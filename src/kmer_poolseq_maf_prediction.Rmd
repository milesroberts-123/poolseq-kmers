...
#kmer_pairs = read.csv(paste("/mnt/scratch/robe1195/Josephs_Lab_Projects/poolseq-kmers/workflow/hetmers_", i, "_seqs.csv", sep = ""), col.names = c("k1", "k2"))

#kmer_covs = read.csv(paste("/mnt/scratch/robe1195/Josephs_Lab_Projects/poolseq-kmers/workflow/hetmers_", i, "_counts.csv", sep = ""), col.names = c("c1", "c2"))
...
```{r}
#
ggplot(pares, aes(x = as.factor(cov), y = kmer_vs_truth_maf_cor)) +
  geom_boxplot() +
  theme_classic()
...
for(i in simids){
  # load in actual allele freqs from simulations
  true_af_p1 = read.table(paste("/mnt/scratch/robe1195/Josephs_Lab_Projects/poolseq-kmers/workflow/slim_allele_freqs_", i, "_p1.txt", sep = ""), col.names = c("chrom", "pos", "ns", "af", "ac"))
  
    true_af_p2 = read.table(paste("/mnt/scratch/robe1195/Josephs_Lab_Projects/poolseq-kmers/workflow/slim_allele_freqs_", i, "_p2.txt", sep = ""), col.names = c("chrom", "pos", "ns", "af", "ac"))
  ...
  # load pairs of k-mers
  kmer_pairs_p1 = read.table(paste("/mnt/scratch/robe1195/Josephs_Lab_Projects/poolseq-kmers/workflow/", "kmerpairs_", i, "_p1_sequences.tsv", sep = ""), col.names = c("k1"))

  kmer_covs_p1 = read.table(paste("/mnt/scratch/robe1195/Josephs_Lab_Projects/poolseq-kmers/workflow/kmerpairs_", i, "_p1_coverages.tsv", sep = ""), col.names = c("c1", "c2"))
