...
ggplot(plotdata, aes(x = n, y = mean_dist, color = simtype)) +
  geom_boxplot() +
  theme_classic() +
  labs(x = "Pool size", y = "Distance between adjacent SNPs (bp)", color = "Simulation\ntype", title = "Ground truth")
...
ggplot(plotdata_unitigs, aes(x = sc, color = simtype)) +
  geom_density() +
  theme_classic() +
  facet_grid(cov ~ .) +
  geom_vline(xintercept = 1.5e6/2, lty = 2, lwd = 1.5) +
...
#
bench_params$workflow = NA

bench_params$workflow[]
