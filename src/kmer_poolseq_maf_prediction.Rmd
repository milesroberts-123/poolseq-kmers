...
kmer_pairs = read.table("/mnt/scratch/robe1195/Josephs_Lab_Projects/kmers_poolseq/smudgetest_middle_sequences.tsv", col.names = c("k1"))

kmer_covs = read.table("/mnt/scratch/robe1195/Josephs_Lab_Projects/kmers_poolseq/smudgetest_middle_coverages.tsv", col.names = c("c1", "c2"))
