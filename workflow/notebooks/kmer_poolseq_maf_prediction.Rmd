...
hetmers_seqs = read.csv(paste("/mnt/scratch/robe1195/Josephs_Lab_Projects/poolseq-kmers/workflow/hetmers_", i, "_seqs.csv", sep = ""), col.names = c("k1", "k2"))

hetmers_counts = read.csv(paste("/mnt/scratch/robe1195/Josephs_Lab_Projects/poolseq-kmers/workflow/hetmers_", i, "_counts.csv", sep = ""), col.names = c("c1", "c2"))

hetmers_bayes = read.csv(paste("/mnt/scratch/robe1195/Josephs_Lab_Projects/poolseq-kmers/workflow/hetmers_", i, "_bayes_states.csv", sep = ""), col.names = c("bc"))
...
true_af = read.table(paste("/mnt/scratch/robe1195/Josephs_Lab_Projects/poolseq-kmers/workflow/slim_allele_freqs_", i, ".txt", sep = ""), col.names = c("chrom", "pos", "ref", "alt", "ns", "af", "ac"))
...
disco = read.table(paste("/mnt/scratch/robe1195/Josephs_Lab_Projects/poolseq-kmers/workflow/discoRes_ad_", i, ".txt", sep = ""), col.names = c("chrom", "pos", "ref", "alt", "c1", "c2"))
...
# load poolsnp calls
poolsnp = read.table(paste("/mnt/scratch/robe1195/Josephs_Lab_Projects/poolseq-kmers/workflow/poolsnp_final_", i, ".txt", sep = ""), col.names = c("chrom", "pos", "ref", "alt", "c1", "t"), fill = T, na.strings = "")
...
plotdata_div = melt(pares[,c("ID", "cov", "n", "pe_div_kmer", "pe_div_hetmer", "pe_div_disco", "pe_div_varscan", "pe_div_poolsnp")], id = c("ID", "cov", "n"))

plotdata_div$variable = gsub("pe_div", "", plotdata_div$variable)
...
# ggplot(pares, aes(x = log10(true_div), y = log10(kmer_div), color = as.factor(cov))) +
#   geom_point() +
...
unitig_files = list.files(path = "/mnt/scratch/robe1195/Josephs_Lab_Projects/poolseq-kmers/workflow/blast_results", pattern = ".*txt", full.names = T)

unitig_files_ids = as.numeric(gsub(".txt", "", gsub("/mnt/scratch/robe1195/Josephs_Lab_Projects/poolseq-kmers/workflow/blast_results/", "", unitig_files)))
