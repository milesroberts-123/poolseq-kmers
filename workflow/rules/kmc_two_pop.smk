rule kmc_two_pop:
    ...
    output:
        ...
        p1p2=temp("kmc_results/kmer_counts_{ID}_p1p2.txt"),
        ...
        union_R1_R2_u1_u2_p1p2_pre=temp("union_R1_R2_u1_u2_{ID}_p1p2.kmc_pre"),
    ...
    shell:
        ...
        # combine k-mer counts in the too pools
        kmc_tools simple union_R1_R2_u1_u2_{wildcards.ID}_p1 union_R1_R2_u1_u2_{wildcards.ID}_p2 union union_R1_R2_u1_u2_{wildcards.ID}_p1p2 &>> {log}
        ...
        kmc_tools transform union_R1_R2_u1_u2_{wildcards.ID}_p1p2 dump {output.p1p2} &>> {log}
