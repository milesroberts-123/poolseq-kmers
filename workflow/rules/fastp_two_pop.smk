rule fastp_two_pop:
	...
	shell:
		"""
		fastp -u 40 -q 30 -l 31 -i {input.read1_p1} -I {input.read2_p1} -o {output.pread1_p1} -O {output.pread2_p1} --unpaired1 {output.uread1_p1} --unpaired2 {output.uread2_p1} &> {log}

		fastp -u 40 -q 30 -l 31 -i {input.read1_p2} -I {input.read2_p2} -o {output.pread1_p2} -O {output.pread2_p2} --unpaired1 {output.uread1_p2} --unpaired2 {output.uread2_p2} &> {log}
		"""
